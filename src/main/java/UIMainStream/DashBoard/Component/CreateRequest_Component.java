...
public class CreateRequest_Component extends javax.swing.JPanel {
	...
	private void addDateInputClamper(JTextField textField, int min, int max, int digitSize, boolean isDay) {
		textField.getDocument().addDocumentListener(new DocumentListener() {
			@Override
			// -----------------------------------------
			public void insertUpdate(DocumentEvent e) {
				clampingInput(e, textField, min, max, digitSize, isDay);
			}
			...
			private void clampingInput(DocumentEvent e, JTextField textField, int min, int max, int digitSize,
						...
						if (!textField.getText().isEmpty()) {
							...
							if (i < min) {// Validating
								...
								javax.swing.SwingUtilities
										.invokeLater(() -> textField.setText(Integer.toString(maxDay)));
							}
						}
				...
				try {
					...
					javax.swing.SwingUtilities.invokeLater(() -> textField.setText("")); // Clear non-numeric input.
																							// how? I aint know :)))
				}
			}
		});
